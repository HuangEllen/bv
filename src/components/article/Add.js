...
class Add extends Component {
    ...
    add = (evt) => {
        ...
        const {
            // id,
            b = JSON.parse(localStorage.getItem("member")),
            // usid,
            pro_name,
            pro_type,
            star,
        ...
        //     delete article.id;
        //console.log(this.state)
        for (var i = 0, max = art_pic1.length; i < max; i++) {
            formData.append('art_pic' + i, art_pic1[i]);
        }
    ...
    img_onChange1 = (evt) => {
        ...
        //     case 'art_pic1':
        this.setState({ art_pic1: evt.target.files });
        //     break;
        // default:
